...
?>
	<p></p> <div class="row-fluid"><div class="box color_6"><div class="content">
	<h3>
	Couldn't configure Facebook
...
?>
	...
	<?php echo admin_url('admin-ajax.php?action=WhiterzAuth&Service=Facebook');	?>",250)'>
	<b>
...
<?php echo $Acct->name;?>
	<a href="https://www.facebook.com/pages/WHITERZ/<?php echo $Acct->id;?>" target="_blank" class='label label-info'>Get to Page</a>
	</label>
	</div>
<?php }?>
	<p>
	</p>
	<a href='javascript:void(0)' class='btn btn-warning btn-sm' onclick='javascript:WhiterzPopup("<?php echo admin_url('admin-ajax.php?action=WhiterzClearCookie&Service=Facebook'); ?>",250)'>
	<b>
